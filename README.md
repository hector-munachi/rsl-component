...
# rsl-component <div style="border-radius: 50%; overflow: hidden; width: 40px; height: 40px;">
  <img src="./public/ng-flag.png" alt="Image Alt Text" style="width: 100%; height: auto;">
</div>
