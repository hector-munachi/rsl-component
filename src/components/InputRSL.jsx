...
const InputRSL = () => {
  ...
  const handleRegionChange = (state) => {
    // Set the selected region based on the selected state
    const region = Object.keys(regions).find(region => regions[region].includes(state));
  ...
  const handleStateChange = (e) => {
    ...
    setSelectedLga('');
    // Call handleRegionChange to set the selected region based on the selected state
